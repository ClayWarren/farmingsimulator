...
export class TimeSystem {
    ...
    update(deltaTime: number): void {
        ...
        const minutesToAdd = Math.floor(this.realTimeAccumulator * gameMinutesPerSecond);
    ...
    getFormattedTime(): string {
        const hour12 = this.timeData.hour === 0 ? 12 : this.timeData.hour > 12 ? this.timeData.hour - 12 : this.timeData.hour;
