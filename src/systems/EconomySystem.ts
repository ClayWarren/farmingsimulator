...
export class EconomySystem {
    ...
    buySeeds(cropType: CropType, quantity: number = 1): boolean {
        ...
        if (this.money >= totalCost) {
            ...
            console.log(`Not enough money to buy ${quantity} ${cropType} seeds (need $${totalCost}, have $${this.money})`);
            return false;
        }
    }
    ...
    sellCrop(cropType: CropType, quantity: number): boolean {
        ...
        if (currentInventory >= quantity) {
            ...
            console.log(`Not enough ${cropType} in inventory (have ${currentInventory}, trying to sell ${quantity})`);
            return false;
        }
    }
