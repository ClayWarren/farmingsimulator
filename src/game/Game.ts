import { Engine, Scene, FreeCamera, Vector3, HemisphericLight, Color3, WebGPUEngine } from '@babylonjs/core';
...
export class Game {
    ...
    private initializeSystems(): void {
        ...
        this.inputManager = new InputManager(this.scene, this.canvas, this.cropSystem, this.economySystem, this.vehicleSystem);
        this.uiManager = new UIManager(this.timeSystem, this.weatherSystem, this.cropSystem, this.economySystem);
